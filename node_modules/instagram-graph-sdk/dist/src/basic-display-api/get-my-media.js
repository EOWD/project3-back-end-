...
exports.getMyMedia = void 0;
var config_1 = require("../config");
var base_get_media_1 = require("../base-get-media");
/**
 ...
 */
function getMyMedia(props) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, base_get_media_1.internalGetMediaForUser(config_1.config.basicDisplayApiBaseUrl, __assign(__assign({}, props), { user_id: 'me' }))];
        });
    });
}
