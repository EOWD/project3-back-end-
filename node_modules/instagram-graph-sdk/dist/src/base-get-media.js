...
exports.internalGetMediaForUser = void 0;
var node_fetch_1 = __importDefault(require("node-fetch"));
var resize_instagram_media_1 = require("./resize-instagram-media");
function internalGetMediaForUser(baseApiUrl, _a) {
    var e_1, _b;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    requestUrl = baseApiUrl + "/" + user_id + "/media";
                ...
                case 4:
                    ...
                    return [4 /*yield*/, Promise.all(resize_to.map(function (resizeConfig) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, resize_instagram_media_1.resizeInstagramMedia(media, resizeConfig)];
                                    case 1:
                ...
                case 6:
                    ...
                    return [4 /*yield*/, resize_instagram_media_1.resizeInstagramMedia(media, include_thumbnail)];
                case 7:
...
exports.internalGetMediaForUser = internalGetMediaForUser;
